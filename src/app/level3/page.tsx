  ...
  return (
    ...
    >
      ...
      <motion.button
        ...
        className="mt-8 px-8 py-4 text-lg sm:text-xl font-bold text-white bg-purple-700 border-4 border-pink-400 rounded-lg shadow-lg hover:scale-110 transition-transform"
