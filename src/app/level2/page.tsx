      ...
      <div className="relative z-10 flex flex-col items-center max-w-4xl mx-auto px-4">
        ...
        >
          <div className="relative inline-block">
            <h1
              className="text-5xl sm:text-7xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-pink-500 to-purple-500"
              style={{
            ...
            <div
              className="absolute -bottom-2 -left-2 w-4 h-4 bg-purple-500 rounded-full animate-pulse"
        ...
        <motion.div
          className="w-full max-w-lg mb-12 aspect-video relative"
        ...
        >
          ...
          <div className="absolute -bottom-5 left-10 right-10 bg-gradient-to-r from-purple-900/90 to-indigo-900/90 py-3 px-6 rounded-lg border border-purple-700 flex justify-between items-center">
            <div className="flex flex-col">
              <span className="text-xs text-cyan-300">DIFFICULTY</span>
              <div className="flex mt-1">
                <div className="w-4 h-2 bg-green-500 mr-1 rounded-sm" />
                <div className="w-4 h-2 bg-green-500 mr-1 rounded-sm" />
                <div className="w-4 h-2 bg-gray-600 mr-1 rounded-sm" />
                <div className="w-4 h-2 bg-gray-600 mr-1 rounded-sm" />
        ...
        >
          <div className="inline-block bg-gradient-to-r from-purple-900/70 to-indigo-900/70 py-4 px-6 rounded-lg border border-purple-700">
            <p className="text-base sm:text-lg text-cyan-50">
              Discover what makes me{" "}
              <span className="text-pink-400 font-bold">unique</span>. Learn
              more about my skills and the technologies I can work with!
            </p>
          </div>
        </motion.div>
        ...
        {!isPlayerReady ? (
          ...
          >
            ...
            <div className="relative px-12 py-5 bg-black rounded-lg leading-none flex items-center">
              <span className="text-2xl font-bold text-white border-r border-pink-500 pr-4">
                READY
              </span>
              <span className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-pink-400 to-purple-400 pl-4">
                PLAYER 1
              </span>
            </div>
          </motion.button>
        ...
        {isPlayerReady && (
          <div className="fixed bottom-6 left-0 right-0 flex justify-center pointer-events-none">
            <motion.div
              className="bg-black/70 border border-purple-700 px-8 py-3 rounded-full"
              initial={{ y: 100 }}
              animate={{ y: 0 }}
        ...
        <div className="fixed top-6 left-6 flex items-center space-x-2 opacity-70">
